...
func (m *MockIContainerRepository) Update(containerId string, updateData dto.ContainerUpdate) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", containerId, updateData)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockIContainerRepositoryMockRecorder) Update(containerId, updateData interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockIContainerRepository)(nil).Update), containerId, updateData)
}
